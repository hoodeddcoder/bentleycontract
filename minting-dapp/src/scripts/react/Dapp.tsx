        ...
        :
          <div className="no-wallet">
            ...
            <div className="use-block-explorer">
              Hey, Welcome to <strong>BentleyBae</strong> <span className="emoji"></span><br />
            ...
            {!this.isWalletConnected() || this.state.isWhitelistMintEnabled ?
              <div className="merkle-proof-manual-address">
               <h2>Whitelist Proof</h2>
                <p>
                  Are you sure you're on the whitelist? <strong>Verify</strong> if you are by pasting your wallet address below!
                </p>
